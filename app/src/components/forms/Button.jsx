...
const Button = ({
  ...
  const baseStyles = 'inline-flex items-center justify-center font-semibold rounded-xl transition-all duration-200 focus:outline-none focus:ring-2 disabled:opacity-50 disabled:cursor-not-allowed';
  ...
  const variants = {
    ...
    ghost: 'hover:bg-slate-55 dark:hover:bg-slate-800 text-slate-650 dark:text-slate-350 focus:ring-slate-500/10',
  };
